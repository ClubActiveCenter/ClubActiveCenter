...
const Dashboard = () => {
  return (
    <div className="min-h-screen bg-black text-white flex justify-center items-center">
      <div className="max-w-7xl w-full flex gap-8 p-8">
        <aside className="w-1/4 bg-white text-black rounded-xl p-6 shadow-md">
        ...
        <main className="w-3/4 bg-gray-200 text-black rounded-xl p-8 shadow-md">
