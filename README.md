...
Ejemplos de archivos o carpetas especificas (Next utiliza sistema de carpetas para rutas):
...
# 🚀 PASO A PASO PARA HACER UN PULL REQUEST Y SUBIR UN CAMBIO A LA RAMA PRINCIPAL (MAIN) (PASOS MÁS ESPECIFICOS)
